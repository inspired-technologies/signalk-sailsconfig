...
## Deprecation Notice
This plugin has been re-based on the orginal SailConfiguration plugin but adds Sail Management functionality via REST APIs. This has been proposed as PR to the maintainers. Once the PR is accepted, this additional plugin may be obsolete and could be deprecated.  

## Plugin Config Update
Regardless if moving to @signalk-sailsconfiguration or upgrading from an earlier version of signalk-sailsconfig, the plugin configuration file needs to be upgraded to the latest structure. Instead of re-creating from scratch you can use your preferred AI chat solution (eg. Claude, ChatGPT, etc.) by leverarging the attached [prompt](./re-config.md#sail-configuration-transformation-instructions).
...
- v0.9.0 Re-based to v1.1.0 of @signalk/sailsconfiguration
- v0.9.5 Re-based to v1.2.0 of @signalk/sailsconfiguration incling PR SailManagement
